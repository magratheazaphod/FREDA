...
\section*{Decadal Changes}
	...
	Spatial changes in rainfall between sets of years for key time periods are shown in Figure~\ref{fig:type_changes} and decomposed into banded and local rainfall changes. Figure~\ref{fig:hov_changes}) similarly shows zonally averaged banded and local rainfall changes for the entire year in Hovm\''oller plot format, as well as changes in rainband intensity and frequency at each latitude. Finally, Figure~\ref{fig:bars} uses bootstrapping to determine the significance of the overall changes in rainband latitude, frequency and intensity during key time periods. Results for 1980-2007 versus 1951-1979 and 1994-2007 versus 1980-2007 are discussed below; each set of decadal changes has previously been reported in the literature (\citep{Gong2001} and \citep{Kwon2007,Wu2010,Yim2013}).

\subsection*{1980-2007 versus 1951-1979}

	A meridional dipole of decadal rainfall change is visible in Figure~\ref{fig:type_changes} over East China corresponding to the South Flood-North Drought. Pronounced local shifts are also visible in Taiwan, South Korea and parts of Japan. Annual changes in northern China between 35$^{\circ}$-40$^{\circ}$N are significant at a 95\% confidence level, whereas changes in central and southern China are not. However, there are substantial changes in central and southern China rainfall during particular Meiyu stages. The decline in North China total yearly rainfall is attributable in largest part to a decline in banded rainfall during the Post-Meiyu (significant at the 99\% level). Also, during the Pre-Meiyu season, a marked decrease in banded rainfall over the Yangtze River Valley (also significant at the 99\% level) is partially offset by a general increase in local rainfall across all of China, especially in the vicinity of Hunan, Guizhou and Chongqing Provinces (108$^\circ$-114$^\circ$E, 26$^\circ$-30$^\circ$N). While Figure~\ref{fig:hov_changes} shows some significant changes also in winter rainfall, yearly total changes in Figure~\ref{fig:type_changes} are dominated by changes in rainy season banded rainfall. Banded and local rainfall changes in all seasons are generally uncorrelated.

	Changes in rainbands can further be decomposed into changes in frequency or intensity. Figure~\ref{fig:hov_changes}) shows a H\"ovmoller plot of changes in frequency and intensity for the entire year, with only changes significant at a 95\% level shown. The most coherent significant changes in rainband frequency occur during the pre-Meiyu around 30$^\circ$N, and during the post-Meiyu around 35$^\circ$N, while there are no concerted changes in intensity during the warm rainy period. The probability of observing a rainband during the Pre-Meiyu declined from $59.0\% \pm 2.0\%$ to $53.0\% \pm 2.1\%$ ($p=0.020$; Figure~\ref{fig:bars}), corresponding to an XXX mm/day decline in total rainfall. Several authors have previously reported a decrease in Pre-Meiyu rainfall at the end of the \nth{20} century \citep{Xin2006,Wang2009}. 
	
	For the Post-Meiyu (days 201-273, or July 20-Sep 30), we specifically analyze rainbands occurring north of 27$^{\circ}$N, since rainbands in southern China during this time period are likely produced by typhoons, distinct from other mechanisms of rainband formation. Mean rainband latitude during 1951-1979 was $33.6^\circ \textrm{N} \pm .3^\circ$ for events north of 27$^{\circ}$N, versus $32.9^\circ \textrm{N} \pm .3^\circ$ during 1980-2007 ($p=.0003$; Figure~\ref{fig:bars}). This shift remains significant if we do not restrict by front latitude ($p=.0048$). As a result, yearly rainfall has increased in central China even though Pre-Meiyu rainfall changes in that region are actually negative (Figure~\ref{fig:hov_changes}). Unlike reference \cite{Yu2010}, our catalog does not exhibit a \nth{20}-century decreasing trend in the intensity of Yangtze River region frontal rainbands during July-August. A significant southward shift in rainband latitude is also found for the whole year ($p=.0032$; Figure~\ref{fig:bars}), but this signal is dominated by the Post-Meiyu shift. Kolmogorov-Smirnov (KS) and Anderson-Dearing (AD) tests of changes in distribution confirm the significance of these results (Supplementary Table Sx)
...
\end{figure}	
	...
	In summary, the South Flood-North Drought pattern of change between 1980-2007 and 1951-1979 can be attributed primarily to changes in banded rainfall, and more specifically to changes in the frequency of rainband occurrence. Banded and local rainfall changes follow different spatial patterns.
