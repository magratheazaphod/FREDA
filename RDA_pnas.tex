...
\subsection*{1980-2007 versus 1951-1979}
	...
	Changes in banded rainfall can further be attributed to changes in frequency or intensity. In Figure~\ref{fig:hov_changes}), we observed that changes in banded rainfall between 1980-2007 and 1951-1979 are dominated by changes in \textit{frequency}, while no significant changes in intensity are found, contrary to the findings of \cite{Yu2010}. The probability of observing a rainband during the Pre-Meiyu declined from $59.0\% \pm 2.0\%$ to $53.0\% \pm 2.1\%$ ($p=0.020$; Figure~\ref{fig:bars}), leading to an XXX mm/day decline in banded rainfall. The decrease in late-twentieth-century Pre-Meiyu rainfall was previously reported in \citep{Xin2006,Wang2009}. 
