...
\section*{Decadal Changes}
	...
	Spatial changes in rainfall between sets of years for key time periods are shown in Figure~\ref{fig:type_changes} and decomposed into banded and local rainfall changes. Figure~\ref{fig:bars} uses bootstrap methods to determine the significance of the overall changes in rainband latitude, frequency and intensity during key time periods Finally, Figure~\ref{fig:hov_changes} similarly shows zonally averaged banded and local rainfall changes for the entire year in Hovm\"oller plot format, as well as changes in rainband intensity and frequency at each latitude. We compare 1980-2007 versus 1951-1979 and 1994-2007 versus 1980-2007 below.
