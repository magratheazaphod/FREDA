...
\significancestatement{Eastern China experienced a late-twentieth-century change in rainfall known as the ``South Flood-North Drought.'' Permanently altered rainfall in this densely populated region would have severe humanitarian repercussions. We employ a novel image processing algorithm that detects rainbands, a key component of summer Chinese weather, and also classifies rainfall as either banded or ``local'' (non-banded). Changes in the frequency of banded rainfall contributed most to rainfall changes across 1951-2007, with an uptick in banded rainfall intensity after 1993. In contrast, there is no significant trend in non-banded rainfall.The classification yields a new perspective that may distinguish the different mechanisms for historical rainfall change, and provides a new framework for diagnosis of the relative impacts of global warming, aerosols and natural variability.}
