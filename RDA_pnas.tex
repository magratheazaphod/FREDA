...
\dropcap{E}astern China receives about 60\% of its precipitation from May to August via the East Asian summer monsoon. The period of peak rainfall lasting from early June to mid-July is called ``Meiyu season'' (lit. ``plum rains,'' referring to the spectacular growth of plum blossoms in central China with the onset of heavy rains). During this time, heavy rainfall occurs in zonal bands resulting from frontal synoptic conditions (the ``Meiyu Front''). The summer meteorology of Japan and Korea also features similar phenomena (the ``Baiu'' and ``Changma'' respectively). The contribution from these rainbands leads to a rainfall seasonality in the East Asian monsoon that is unique relative to other monsoon circulations \citep{Ding2005}. More generally, rainbands are a year-round feature of East Asian rainfall, attributed to the interplay between the East Asian tropospheric jet and Tibetan Plateau \citep{Molnar2010,Sampe2010,Chen2014}.
	...
	We have developed an image processing algorithm, the Rainband Detection Algorithm (RDA), which locates rainbands in daily precipitation maps and quantifies attributes such as latitude and intensity. By applying this algorithm to 57 years of daily rainfall maps for East China (defined hereafter as the region inside of 105$^{\circ}$E-123$^{\circ}$E and 20$^{\circ}$N-40$^{\circ}$N), we create a database all of rainband occurrences in China during the years 1951-2007 (20,819 days total). This data allows for a visualization of the climatological progression of rainbands across the year by tracking changes in frequency and intensity (Figure~\ref{fig:hov_climo}). We also classify all rainfall on each day as either ``banded'' or ''local'' based on proximity to a detected rainband. In the rest of this work, we apply this toolkit to investigate several decadal changes, in particular the ``South Flood-North Drought'' phenomenon reported in East China post-1980 \citep{Hu1997,Gong2002,Nigam2013}, and also another reported change in rainfall between 1994-2007 and 1980-1993 \citep{Wu2010,Kajikawa2012,Zou2015}. Several previous studies have compiled information on the variability of the Meiyu front on decadal and centennial timescales \citep{Chen2004,Ge2008,Xu2009}, but to our knowledge no previous author has compiled a multi-decadal catalog of rainband events.
