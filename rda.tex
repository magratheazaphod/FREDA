...
\subsection{1979-1993 versus 1994-2007}
	...
	We repeat the analysis from 1980-2007 versus 1951-1979 shown above for these two time periods (Figure \label{fig:hov_freq_int_9407_8093}).
...
\section{Conclusion}
	...
	The use of RDA reveals insights about China rainfall that are not available using any of the alternative metrics explored by previous authors.
...
%%FIGURE 6 Decadal mean in different rainfall types during different time periods
\begin{figure}[htb]
\centering
...
%%FIGURE 8 - the South Flood-North Drought shown in a single figure.
\begin{figure}
\centering
...
%%FIGURE 9 Changes in rainfall by type between 1951-1979 and 1980-2007
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=44pc]{Figures/chinarain_diff_5179_8007}
\caption{15-day running mean of the change in a) total rainfall b) banded rainfall and c) local rainfall between 1980-2007 and 1951-1979. All changes shown are significant at a 95\% level, and significance exceeding a 99\% level is contoured in gray, as calculated by a moving blocks bootstrap with block length of 2 days and 2,000 iterations.}
...
%%FIGURE 10 Changes in rainfall by type between 1980-1993 and 1994-2007
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=44pc]{Figures/chinarain_diff_8093_9407}
\caption{15-day running mean of the change in a) total rainfall b) banded rainfall and c) local rainfall between 1994-2007 and 1980-93. All changes shown are significant at a 95\% level and significance exceeding a 99\% level is contoured in gray, as calculated by a moving blocks bootstrap with block length of 2 days and 2,000 iterations.}
\label{fig:rain_diff_2}
\end{figure}

%%FIGURE 10 Climatology of alternative metrics of China rainfall
\begin{figure}[htb]
\centering
...
%%FIGURE 12 Decadal changes in different rainfall types
...
%%FIGURE 13 Significance of attribute changes in rainbands between decades
\begin{figure}[htbp]
\centering
...
%%FIGURE 14 Hovmoller climatology of band frequency, intensity and "effective rainfall"
\begin{figure}[htbp]
\centering
...
%%FIGURE 15 Hovmoller climatology of band frequency, intensity and "effective rainfall"
\begin{figure}[htbp]
\centering
...
%%FIGURE 16 Hovmoller climatology of band frequency, intensity and "effective rainfall"
\begin{figure}[htbp]
\centering
