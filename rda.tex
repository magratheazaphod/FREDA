...
\section{Conclusion}
	...
	Depending on whether global warming or aerosols are implicated, we might expect late \nth{20}-century trends to be further exacerbated, or instead to return to their \nth{20} century baseline.
	\citet{Zhao2010} previously suggested that the South Flood-North Drought was associated with the late \nth{20}-century rise in global mean surface temperature. Other authors have suggested changes in Indian Ocean SST \citep{Qu2012}, decreased sensible heating from the Tibetan Plateau \citep{Liu2012a,Hu2015} and aerosol forcing \citep{Song2014} as culprit.
...
%%FIGURE 5.5 Changes in rainfall by type between 1980-1993 and 1994-2007
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=36pc]{Figures/hov_types_climo}
\caption{}
\label{fig:hov_types}
\end{figure}
...
%%FIGURE 7 Decadal mean in different rainfall types during different time periods
\begin{figure}[htb]
\centering
...
%%FIGURE 8 Decadal mebanded_frac_climoan in different rainfall types during different time periods
\begin{figure}[htb]
\centering
...
%%FIGURE 9 Comparison of alternative metrics of China rainfall, 1980-2007 versus 1951-1979
\begin{figure}[htb]
\centering
...
%%FIGURE 10 Comparison of alternative metrics of China rainfall, 1994-2007 versus 1980-1993
\begin{figure}[htb]
\centering
...
%%FIGURE 11 - the South Flood-North Drought shown in a single figure.
\begin{figure}
\centering
...
%%FIGURE 12 Decadal changes in different rainfall types, 1951-1979 v 1980-2007
\begin{figure}[htb]
\centering
\noindent\includegraphics[width=36pc]{Figures/changes_by_type_8007_5179}
...
%%FIGURE 13 Decadal changes in different rainfall types, 1994-2007 v 1980-1993
\begin{figure}[htb]
\centering
\noindent\includegraphics[width=36pc]{Figures/changes_by_type_9407_8093}
\caption{1980-2007 versus 1951-1979 changes in total, banded and local rainfall for full year, Pre-Meiyu (days 121-160), Meiyu (days 161-200) and Post-Meiyu (days 201-273), with significance at the 95\%/99\% level marked by single/double hatches (permutation test with 1,000 iterations). \textit{Banded} rainfall consists of all rainfall falling within 4$^{\circ}$ of a rainband axis and rainfall at any other adjacent point exceeding 10 mm day$^{-1}$. \textit{Local} rainfall includes all rainfall not meeting these criteria.}
\label{fig:type_decadal_9407_8093}
\end{figure}


%%FIGURE 14 Significance of attribute changes in rainbands between decades
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=34pc]{Figures/RDA_bars}
...
%%FIGURE 15 Changes in rainfall by type between 1951-1979 and 1980-2007
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=43pc]{Figures/hov_summary_8007_5179}
...
%%FIGURE 16 Changes in rainfall by type between 1980-1993 and 1994-2007
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=43pc]{Figures/hov_summary_9407_8093}
