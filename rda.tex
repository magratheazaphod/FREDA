...
%%FIGURE 6 Hovmoller climatology of rainfall amount by type - total, banded and local
\begin{figure}[htbp]
\centering
\noindent\includegraphics[width=36pc]{Figures/hov_types_climo}
\caption{Hovm\"oller climatology of a) total rainfall, b) banded rainfall and c) local rainfall, 15-day running mean and d) Eastern China mean of each type, where Eastern China is defined for our purposes as the region between 105-123$^{\circ}$E and 20-40$^{\circ}$N }
\end{figure}
