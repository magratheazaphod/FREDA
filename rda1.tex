...
\title{A 57-year catalog of frontal rainfall in China using the Rainband Detection Algorithm (RDA). Part I: Climatology and Decadal Change}
...
\subsection{Decadal Change in Rainfall Types}
	...
	In conclusion, \textbf{the North Flood-South Drought has resulted primarily from changes in banded rainfall}. In turn, these changes in banded rainfall are zonally symmetric and coherent across thousands of kilometers. 
...
\section{Conclusion}
	...
	The use of RDA runs the risk of conflating storms produced by different mechanisms in spite of our quality control screening. For instance, a zonally propagating cyclone would be registered by RDA although its dynamics are much different and its direction of propagation opposite. Nonetheless, we assert that it is generally successful in differentiating between storm tracks that are produced by large-scale synoptic conditions and local storms powered by orographic effects or self-buoyancy, whose spatial extent will be much more limited. As shown in Figure~\ref{fig:f31}, decadal changes in China rainfall (the ``South Flood-North Drought'') primarily reflect changes in banded rainfall, as opposed to local storms. The existence of banded rainfall depends on large-scale attributes of the East Asian monsoon such as a sharp gradient in moisture between southern and northern China,  and standing eddies in the East Asian tropospheric jet due to topographic blocking by the Tibetan Plateau \citep{Molnar2010,Chen2015}. Therefore, we suggest that observed changes in banded rainfall reflect a change in the large-scale dynamics of the East Asian summer monsoon in the late \nth{20} century. This idea is further investigated in Part II.
