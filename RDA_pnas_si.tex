...
%%FIGURE 5 - Climatology of banded and local rainfall + area average
\begin{figure}[htbp]
\centering
...
%%FIGURE 6 Decadal mebanded_frac_climoan in different rainfall types during different time periods
\begin{figure}[htb]
\centering
