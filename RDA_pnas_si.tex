...
%%FIGURE 5 Decadal mean of banded_frac_climo in different rainfall types during different time periods
\begin{figure}[htb]
\centering
...
%%FIGURE 6 - Climatology of banded and local rainfall + area average
\begin{figure}[htbp]
\centering
...
%%FIGURE 7 Comparison of alternative metrics of China rainfall, 1980-2007 versus 1951-1979
\begin{figure}[htb]
\centering
...
%%FIGURE 8 Comparison of alternative metrics of China rainfall, 1994-2007 versus 1980-1993
\begin{figure}[htb]
\centering
...
%%FIGURE 9 - the South Flood-North Drought shown in a single figure.
\begin{figure}
\centering
